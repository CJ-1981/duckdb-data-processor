...
class CSVConnector(BaseConnector):
    ...
    # @MX:ANCHOR: CSV data reading entry point (fan_in >= 3: import, streaming, validation)
    # @MX:REASON: Core data ingestion method for all CSV operations
    def read(self, source: str, **kwargs) -> Iterator[Dict[str, Any]]:
        ...
        """
        yield from self.read_csv(source, **kwargs)
    ...
    def validate(self, source: str, **kwargs) -> bool:
        ...
        Args:
            source: Path to CSV file
            **kwargs: Additional validation options (unused in base implementation)
        ...
        """
        _ = kwargs  # Reserved for future extensions
        return self.validate_csv_path(source)
    ...
    def get_metadata(self, source: str, **kwargs) -> Dict[str, Any]:
        ...
        Args:
            source: Path to CSV file
            **kwargs: Additional metadata options (unused in base implementation)

        Returns:
            Dictionary with file statistics
        """
        _ = kwargs  # Reserved for future extensions
        return self.get_statistics(source)
