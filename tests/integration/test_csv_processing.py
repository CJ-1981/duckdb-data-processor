...
# @MX:ANCHOR: CSV integration test suite (fan_in >= 3: CI, e2e validation, performance)
# @MX:REASON: End-to-end validation of CSV connector with real DuckDB integration
